...
(function() {
    ...
    const ICON_MAP = [
        ...
        { parts: ["desinstal·lat"], icon: "delete", color: "#c3342a" },
        { parts: ["instal·lat"], icon: "inventory_2", color: "#c957ddff" },
        ...
        { parts: ["està baixant"], icon: "download", color: "#607d8b" },
        { parts: ["S'ha bloquejat l'usuari"], icon: "block", color: "#f44336" },
        ...
        { parts: ["està reproduint", "a"], icon: "play_arrow", color: "#2196f3" },
        { parts: ["ha començat a reproduir"], icon: "play_arrow", color: "#2196f3" },
        { parts: ["ha acabat de reproduir", "a"], icon: "check_circle", color: "#4caf50" },
